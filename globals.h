...
//	const std::string trecRoot("/research/index/trec06/"); //for trec on dodo
	...
	/*dodo*/
	// const std::string trec_output("/home/qi/trec_output/"); //to generate babyindex
	// const std::string trecRoot("/home/qi/trec_output/"); //main index 
	// const std::string testingQuery("/home/qi/Dropbox/experiments/true_queries_WSDM"); //main query
	// const std::string doclenFileName("/home/qi/clueweb/documentLengths"); //doc lengths
	// const std::string basic_table("/home/qi/Dropbox/experiments/lexicon_baby_712"); //lexicon
	// const std::string score_index_binary("/home/qi/score_index_binary/");//score sorted binary dir
	// const std::string pair_index("/home/qi/pair_index/");//pair index top 1000
	// const std::string cr_results("/home/qi/Dropbox/WSDM_Index_Script/500_cr");//cr results
	// const std::string index_depth("/home/qi/Dropbox/experiments/depth_index_10k");//depth index
